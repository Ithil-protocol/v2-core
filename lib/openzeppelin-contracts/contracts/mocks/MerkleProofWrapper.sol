...
contract MerkleProofWrapper {
    ...
    function multiProofVerify(bytes32[] memory proofs, bool[] memory proofFlag, bytes32 root, bytes32[] memory leaves)
        public
        pure
        returns (bool)
    {
    ...
    function processMultiProof(bytes32[] memory proofs, bool[] memory proofFlag, bytes32[] memory leaves)
        public
        pure
        returns (bytes32)
    {
    ...
    function processMultiProofCalldata(bytes32[] calldata proofs, bool[] calldata proofFlag, bytes32[] memory leaves)
        public
        pure
        returns (bytes32)
    {
