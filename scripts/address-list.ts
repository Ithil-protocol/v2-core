...
export const faucetList: Address[] = [
  ...
  // val workwallets
  '0x74978Abc8e5a2C5CDd7A064488f577F36f5E0a2d',
  '0xE3154B7d74b932D26dcCaA5Ed162C50A0f2579CA',
  '0x4E30e1DCb0eB5C422E86f4896385bc14Eca7EdB3',
  // 0xGidone wallets
  '0x424bdddAb2DF3215640782D9D68b709721C6fB33',
]

export const depositorList: Address[] = [
  faucetList[1], // 0xed7E824e52858de72208c5b9834c18273Ebb9D3b
  faucetList[2], // 0x7Ce7DdE0b26a4ABe2fBBCF5c0ff9785dbFB9A72c
]

export const deployerAddress = faucetList[0] // 0x7778f7b568023379697451da178326D27682ADb8
