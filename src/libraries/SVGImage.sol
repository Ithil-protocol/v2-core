...
library SVGImage {
    ...
    function generateMetadata(string memory name, string memory symbol, uint256 id, int256 score)
        internal
        pure
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            ...
                            _getSVGImageBase64Encoded(name, id, score),
                            '","attributes":[]}'
                        )
                    )
                )
    ...
    function _getSVGImageBase64Encoded(string memory strategyName, uint256 id, int256 score)
        internal
        pure
        returns (string memory)
    {
