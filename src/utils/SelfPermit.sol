...
import { ISelfPermit, IERC20PermitAllowed } from "../interfaces/ISelfPermit.sol";

/// @title Self Permit
/// @notice Functionality to call permit on any EIP-2612-compliant token for use in the route
/// @dev These functions are expected to be embedded in multicalls to allow EOAs
// to approve a contract and call a function
/// that requires an approval in a single transaction.
/// @dev forked from https://github.com/Uniswap/v3-periphery/blob/main/contracts/interfaces/ISelfPermit.sol
